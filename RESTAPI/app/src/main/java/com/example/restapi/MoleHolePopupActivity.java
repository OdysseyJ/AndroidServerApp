...
public class MoleHolePopupActivity extends AppCompatActivity {

    MoleHoleRewardRecyclerAdapter rewardRecyclerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rewardRecyclerAdapter = new MoleHoleRewardRecyclerAdapter();
        rewardRecyclerAdapter.clearData();

        for (MoleHoleRewardData tempz : MoleHoleActivity.users){
